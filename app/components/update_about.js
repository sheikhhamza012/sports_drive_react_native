...
export default class home extends Component {
    ...
    update=()=>{
        ...
        if (!this.state.profile.about?.length>0){
            this.setState({isSubmitting:false,errors:{about:true}})
        ...
        return (
            <ImageBackground style={styles.background} source={require('../images/app_background.png')}>
                ...
                <ScrollView style={{marginTop:130}} contentContainerStyle={styles.root}>
                    ...
                    <Field refs={r=>this.about=r} multiline={5} error={this.state.errors.about} value={this.state.profile.about} handleInput={this.handleInput} name="about" placeholder="About" style={{marginTop:10,marginBottom:10}}/>
