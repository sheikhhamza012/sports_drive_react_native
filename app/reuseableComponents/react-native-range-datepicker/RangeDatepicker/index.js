			...
			return (
				<View style={{backgroundColor: '#fff', zIndex: 1000, alignSelf: 'center', width: '100%', flex: 1}}>
...

					{
						...
						(
						<TouchableOpacity onPress={this.handleConfirmDate} style={[styles.buttonWrapper, this.props.buttonContainerStyle]}>
							<Text style={{color:this.props.buttonColor,textAlign:"center",fontSize:18,fontWeight:"bold" }}>Select Date</Text>
						</TouchableOpacity>
						) : null
					}	
				</View>
